...
This project was designed using HTML and CSS and  enhances overall user experience and visual appeal. It has the following sections:
-A header 
...
```bash 
git clone https://github.com/FaridaAdamuMagaji/module-1.git    
